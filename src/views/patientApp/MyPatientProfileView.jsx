            ...
            <Box>
              ...
              <Box>
                <Typography variant='h6' sx={{
                  ...
                  <TextField type="text" id="bloodType" name="bloodType" placeholder='A+' variant="outlined" value={data.bloodType}
                  onChange={handleInputChange}
                  disabled={!edit}
                  sx={{
                    borderRadius: "8px",
              ...
              <Box>
                <Typography variant='h6' sx={{
                  ...
                  <TextField type="text" id="unrelatedClinicalData" name="unrelatedClinicalData" placeholder='Tengo un...' variant="outlined" 
