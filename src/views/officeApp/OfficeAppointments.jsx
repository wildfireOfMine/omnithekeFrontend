...
import { confirmedAppointmentsGet } from '../../store/OfficeSlice';
...
const OfficeAppointments = () => {
    ...
    useEffect(() =>{
        dispatch(confirmedAppointmentsGet()).unwrap().then(data => setData(data));
    }, [dispatch])
    console.log(data);
  ...
  const handleAppointmentForm = () => {
        navigate("/receptionist/inactiveAppointments");
    }
    ...
    <Box
        ...
        >
            Citas del Consultorio Confirmadas
        </Typography>
        ...
        >
            ...
            <CustomButton color="#fff" text="Confirmar citas" backgroundColor='#2563eb' onClick={handleAppointmentForm}/>
        </Box>
        ...
        {data.length > 0 ? (
            ...
            >
            <Typography variant="h6">No existen citas confirmadas</Typography>
            </Paper>
        )}
